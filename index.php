            ...
            <div class="card-deck text-center">
                <div class="card col-lg-3 col-md-3 col-sm-6">
                    <div class="card-body">
                        ...
                        <img src="img/card1.png" alt="truck">
                ...
                <div class="card col-lg-3 col-md-3 col-sm-6 active">
                    <div class="card-body">
                        <h3>Business</h3>
                        <h3>$20 dlls / Unit /Month</h3>
                        <img src="img/card2.png" alt="truck">
                        ...
                        <p class="notes">$50 Monthly License Fee</p>
                    </div>
                </div>
                <div class="card col-lg-3 col-md-3 col-sm-6">
                    <div class="card-body">
                        ...
                        <img src="img/card3.png" alt="truck">
                        <p class="card-text">
                            Employees<br>
                            Asset Management<br>
                            Accident Log and Reporting<br>
                ...
                <div class="card col-lg-3 col-md-3 col-sm-6">
                    <div class="card-body">
                        <h3>Enterprise</h3>
                        <h3>Unlimited</h3>
                        <img src="img/card4.png" alt="truck">
                        <p class="card-text">
                            Employees<br>
                            Asset Management<br>
                            Accident Log and Reporting<br>
                        ...
                        <p class="notes">No Monthly License Fee</p>
                    </div>
                </div>
            </div>
        </div>
